                    ...
                    <div>
                      <h2 className="text-lg font-semibold text-neutral-900">
                        {selectedMember.user.firstName && selectedMember.user.lastName 
                          ? `${selectedMember.user.firstName} ${selectedMember.user.lastName}'s Schedule`
                          : `${selectedMember.user.firstName || selectedMember.user.email}'s Schedule`
                        }
                      </h2>
                      <p className="text-sm text-neutral-600">
                        Activities they've accepted for this trip
                      </p>
                    </div>
                  </div>
                </div>
